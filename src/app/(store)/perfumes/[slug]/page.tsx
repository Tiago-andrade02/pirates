...
function Badge({ label }: { label: string }) {
  return (
    <span className="inline-flex items-center rounded-full border border-line bg-surface px-3.5 py-1.5 text-sm text-muted">
      {label}
    </span>
  );
}
...
export default async function PerfumePage(props: PerfumePageProps) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <nav className="text-sm text-faint" aria-label="Migas de pan">
      ...
      <section className="mt-16 rounded-2xl border border-line bg-surface p-6 sm:p-8">
        <h2 className="font-serif text-2xl text-white">Rendimiento</h2>
